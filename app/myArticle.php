...
$query = mysqli_query($conn, "SELECT * FROM post WHERE user_id = '$user_id'")
...
<div class="rightcolumn">
    ...
    ?>
    <a href="./home.php"><button type='submit' role="button" name='but_submit' class='button-3'  style="background-color: grey;  width: 100%; padding: 10px 20px !important;"><i class='fa fa-home'></i>  Home</button></a>
